...
<?php
      ...
      $sql = "SELECT * FROM `drugs` WHERE `Drug Name` LIKE 'Cetyl Pure';";
              ...
              <ul class="site-menu js-clone-nav d-none d-lg-block">
                ...
                <li class="has-children">
                    ...
                    <ul class="dropdown">
                      ...
                      <li><a href="shop-4.php">Keep me logged in</a></li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <a
              href="shop.php">Store</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Cetyl Pure</strong></div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-5 mr-auto">
            <div class="border text-center">
              <img src="images/product_04.png" alt="Image" class="img-fluid p-5">
            </div>
          </div>
          <div class="col-md-6">
            <h2 class="text-black">Cetyl Pure</h2>
            <p>Buy Cetyl Alcohol pure 500 g Online from Carbanio</p>
            

            <p><del>Rs.899.00</del>  <strong class="text-primary h4"><?php echo 'Rs.'.$mrp; ?></strong></p>
            ...
            <tbody>
                ...
                <th scope="row">Cetyl myristoleate is a fatty acid ester or, more specifically, a cetylated fatty acid (CFA). It is the cetyl ester of myristoleic acid.[1] Preclinical and clinical data show potential benefits in the management of arthritis and fibromylagia.</th>
