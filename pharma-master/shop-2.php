...
<?php
      ...
      $sql = "SELECT * FROM `drugs` WHERE `Drug Name` LIKE 'Chanca Piedra';";
              ...
              <ul class="site-menu js-clone-nav d-none d-lg-block">
                ...
                <li class="has-children">
                    ...
                    <ul class="dropdown">
                      ...
                      <li><a href="shop-2.php">Keep me logged in</a></li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <a
              href="shop.php">Store</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Chanca Piedra</strong></div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-5 mr-auto">
            <div class="border text-center">
              <img src="images/product_02.png" alt="Image" class="img-fluid p-5">
            </div>
          </div>
          <div class="col-md-6">
            <h2 class="text-black">Chanca Piedra</h2>
            <p>Herb Pharm Chanca Piedra Extract for Urinary System Support - 4 Ounce</p>
            
          
            <p><del>Rs.499.00</del>  <strong class="text-primary h4"><?php echo 'Rs.'.$mrp; ?></strong></p>
            ...
            <!-- <div class="mb-5">
              ...
              <input type="hidden" name="Dqty" name="Dqty" value="">
              <script>
...
<p>
            ...
            <tbody>
                ...
                <th scope="row">Chanca piedra, which means "stone breaker" in Spanish, is a small herb. Both Phyllanthus niruri and P. amarus have been called chanca piedra.
                    ...
                    People use chanca piedra for kidney stones. It is also used for hepatitis B, stomach pain, asthma, diabetes, and many other conditions, but there is no good scientific evidence to support these other uses.</th>
