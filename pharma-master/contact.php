<?php
    ...
    if(isset($c_fname) && isset($c_lname) && isset($c_email) && isset($c_subject) && isset($c_message) ){
    $sql = "INSERT INTO `feedback` (`S.No`, `First Name`, `Last Name`, `Email`, `Message`, `Subject`) VALUES (NULL, '$c_fname', '$c_lname', '$c_email', '$c_message', '$c_subject');";
              ...
              <ul class="site-menu js-clone-nav d-none d-lg-block">
                ...
                <li class="has-children">
                  ...
                  <ul class="dropdown">
                    ...
                    <li><a href="contact.php">Keep me logged in</a></li>
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="p-4 bg-white mb-3 rounded">
              <span class="d-block text-black h6 text-uppercase">Hyderabad</span>
              <p class="mb-0">Jubilee Hills,Hyderabad,India.</p>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="p-4 bg-white mb-3 rounded">
              <span class="d-block text-black h6 text-uppercase">Bangalore</span>
              <p class="mb-0">Mount Street,Bangalore,India.</p>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="p-4 bg-white mb-3 rounded">
              <span class="d-block text-black h6 text-uppercase">New Delhi</span>
              <p class="mb-0">Near Lotus Temple,New Delhi,India.</p>
            </div>
          </div>
        </div>
      </div>
