...
<?php
      ...
      $sql = "SELECT * FROM `drugs` WHERE `Drug Name` LIKE 'CLA Core';";
              ...
              <ul class="site-menu js-clone-nav d-none d-lg-block">
                ...
                <li class="has-children">
                    ...
                    <ul class="dropdown">
                      ...
                      <li><a href="shop-5.php">Keep me logged in</a></li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <a
              href="shop.php">Store</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">CLA Core</strong></div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-5 mr-auto">
            <div class="border text-center">
              <img src="images/product_05.png" alt="Image" class="img-fluid p-5">
            </div>
          </div>
          <div class="col-md-6">
            <h2 class="text-black">CLA Core</h2>
            <p>LMusclePharm CLA Core - 180 Caps</p>
            

            <p><del>Rs.999.00</del>  <strong class="text-primary h4"><?php echo 'Rs.'.$mrp; ?></strong></p>
            ...
            <tbody>
                ...
                <th scope="row">CLA is marketed in dietary supplement form for its supposed anti-cancer benefit (for which there is no strong evidence or known mechanism, and very few studies conducted so far)[13] and as a bodybuilding aid.[1] A 2004 review of the evidence said that while CLA seemed to benefit animals, there was a lack of good evidence of human health benefits despite the many claims made for it.[14]

                    Likewise, there is insufficient evidence that CLA has a useful benefit for overweight or obese people as it has no long-term effect on body composition.[15] Although CLA has shown an effect on insulin response in diabetic rats, there is no evidence of this effect in humans.</th>
